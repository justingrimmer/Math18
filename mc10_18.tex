...
\invisible<1-9>{ & = & P(Y_{1}=1)P(Y_{2} =0)\cdots P(Y_{N} =1)} \pause  \nonumber \\
										\invisible<1-10>{& = & \underbrace{P(Y_{1} = 1)P(Y_{3}=1)\cdots P(Y_{M} = 1)}_{M} \times\underbrace{P(Y_{2}= 0) \cdots P(Y_{N} = 0)}_{N-M}  \nonumber} \pause  \\										
...
\invisible<1-2>{var$(X) = E[X^2] - E[X]^2 }\invisible<1-3>{= \lambda^2 + \lambda  - \lambda^2  = \lambda}$
